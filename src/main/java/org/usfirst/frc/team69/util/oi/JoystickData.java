...
public class JoystickData {
     ...
     * @param buttons a list of buttons which are part of the joystick.  This object makes
     * an immutable reference to the list passed in.
     */
    ...
    /**
     * Get an immutable list of buttons on the joystick.  This is actually a
     * list of button/command mappings, so a single button number may be counted
