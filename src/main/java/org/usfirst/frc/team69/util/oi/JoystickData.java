...
public class JoystickData {
     ...
     * @param role
     *            the role the joystick fills
     * @param type
     *            the physical type of joystick
     * @param mapClass
     *            the class inside the oi map representing the joystick
     * @param buttons
     *            a list of buttons which are part of the joystick. This object
     *            makes an immutable reference to the list passed in.
     */
    public JoystickData(int port, Role role, Type type, Class<?> mapClass,
    ...
    /**
     * Get a string representation of the name of the joystick. This is the
     * simple name of the class representing the joystick
     * 
    ...
    /**
     * Get the class used to declare the joystick. This should be a public
     * static class in the oi map which had a {@link MapJoystick} annotation
     * 
    ...
    /**
     * Get an immutable list of buttons on the joystick. This is actually a list
     * of button/command mappings, so a single button number may be counted
     * twice if there are multiple commands on it.
     * 
