...
/**
 * This is the entry point for running RobotInspector. This will verify both the operator interface
 * and port mapping and generate diagrams in the /diagrams directory.
 *
 * <p>The class names for the port map and OI map must be specified in the system properties. The
 * ant build file at ant/robot_inspector.xml should set this up for you.
 *
