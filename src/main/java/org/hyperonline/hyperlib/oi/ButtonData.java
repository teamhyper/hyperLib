...
public class ButtonData {
     ...
     */
    public enum Action {
        WHEN_PRESSED("P"), WHEN_RELEASED("R"), WHILE_HELD("H");
     ...
     * 
     * @param port
     *            The id number of the button, starting at 1
     * @param action
     *            The action which will trigger a command
     * @param field
     *            The field of the OIMap class which corresponds to the command
     *            to run
     */
    ...
    /**
     * Get the name of the button/command mapping. This is the name of the field
     * in OIMap corresponding to this button.
     * 
    ...
    /**
     * Get a string description of the button/command mapping. This includes the
     * action and the name. This is used for making the joystick diagrams.
     * 
