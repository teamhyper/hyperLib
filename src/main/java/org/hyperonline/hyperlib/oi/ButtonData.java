 ...
 * information parsed out of the OI map for a particular binding of a button to a command.
 *
...
public class ButtonData {
   ...
   * @param field The field of the OIMap class which corresponds to the command to run
   */
  ...
  /**
   * Get the name of the button/command mapping. This is the name of the field in OIMap
  ...
  /**
   * Get a string description of the button/command mapping. This includes the action and the name.
   * This is used for making the joystick diagrams.
   *
  ...
  /**
   * An Action describes what action on a button (pressed, released, held) should trigger a command
   * to run.
   *
   * @author James Hagborg
   */
